...
The agent (`@.claude/agents/tests-generator.md`) orchestrates:
...
| File                                                 | Purpose                                                                   |
| ---------------------------------------------------- | ------------------------------------------------------------------------- |
| `@.claude/agents/tests-generator.md`                 | Full 8-phase workflow orchestration                                       |
...
Cursor command collects 4 inputs
    ↓
Invokes @.claude/agents/tests-generator.md
